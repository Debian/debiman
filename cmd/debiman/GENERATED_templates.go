...
var manpageContent = `<!DOCTYPE html>
<html lang="{{ .Meta.LanguageTag }}">
<head>
<meta charset="UTF-8">
<title>{{ .Meta.Name }}({{ .Meta.Section }}) — Debian Manpages</title>
<style type="text/css">
@font-face {
  font-family: 'Inconsolata';
  src: local('Inconsolata'), url(/Inconsolata.woff2) format('woff2'), url(/Inconsolata.woff) format('woff');
...
<ul>
   ...
   <li><a href="./about">About Manpages</a></li>
   <li><a href="./faq">FAQ</a></li>
</ul>
</div>
        <p id="breadcrumbs">&nbsp; <a href="/contents-{{ .Meta.Package.Suite }}.html">{{ .Meta.Package.Suite }}</a> &#x2F; <a href="/{{ .Meta.Package.Suite }}/{{ .Meta.Package.Binarypkg }}/index.html">{{ .Meta.Package.Binarypkg }}</a> &#x2F; {{ .Meta.Name }}.{{ .Meta.Section }}</p>
</div>
<div id="content">
...
`
var manpageerrorContent = `<!DOCTYPE html>
<html lang="{{ .Meta.LanguageTag }}">
<head>
<meta charset="UTF-8">
<title>Error: {{ .Meta.Name }}({{ .Meta.Section }}) — Debian Manpages</title>
<style type="text/css">
@font-face {
  font-family: 'Inconsolata';
  src: local('Inconsolata'), url(/Inconsolata.woff2) format('woff2'), url(/Inconsolata.woff) format('woff');
...
`
var contentsContent = `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
<title>Contents of Debian {{ .Suite }} — Debian Manpages</title>
<style type="text/css">
@font-face {
  font-family: 'Inconsolata';
  src: local('Inconsolata'), url(/Inconsolata.woff2) format('woff2'), url(/Inconsolata.woff) format('woff');
...
<ul>
   ...
   <li><a href="./faq">FAQ</a></li>
        ...
        <p id="breadcrumbs">&nbsp; <a href="/contents-{{ .Suite }}.html">{{ .Suite }}</a> &#x2F; Contents</p>
</div>
<div id="content">
...
`
var pkgindexContent = `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
<title>Contents of {{ .First.Package.Binarypkg }} in Debian {{ .First.Package.Suite }} — Debian Manpages</title>
<style type="text/css">
@font-face {
  font-family: 'Inconsolata';
  src: local('Inconsolata'), url(/Inconsolata.woff2) format('woff2'), url(/Inconsolata.woff) format('woff');
...
<ul>
   ...
   <li><a href="./faq">FAQ</a></li>
        ...
        <p id="breadcrumbs">&nbsp; <a href="/contents-{{ .First.Package.Suite }}.html">{{ .First.Package.Suite }}</a> &#x2F; <a href="/{{ .First.Package.Suite }}/{{ .First.Package.Binarypkg }}/index.html">{{ .First.Package.Binarypkg }}</a> &#x2F; Contents</p>
</div>
<div id="content">
...
<ol>
  ...
  <li>
    Use a browser address bar keyword:
    TODO: elaborate
  </li>
  ...
  <li>
    ...
    <ul>
      <li>
	Debian jessie (TODO: elaborate, link, auto-generate)
      </li>
    </ul>
  </li>
